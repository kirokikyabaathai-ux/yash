...
@media screen and (max-width: 575px) {
  .cascade-slider_arrow-left { left: 5px; top: 95%; }
  .cascade-slider_arrow-right { right: 5px; top: 95%; }
}

@media screen and (min-width: 576px) {
  .cascade-slider_arrow-left { left: -4%; top: 95%; }
  .cascade-slider_arrow-right { right: -4%; top: 95%; }
}
...
@media screen and (min-width: 576px) {
  .cascade-slider_container { height: 65vh; }
...
@media screen and (min-width: 768px) {
  ...
  .cascade-slider_slides img { max-width: 450px; }
}
...
@media screen and (min-width: 991px) {
  ...
  .cascade-slider_slides img { max-width: 500px; }
  .cascade-slider_container { height: 50vh; }
}
...
@media screen and (min-width: 1100px) {
  ...
  .cascade-slider_slides img { max-width: 600px; }
